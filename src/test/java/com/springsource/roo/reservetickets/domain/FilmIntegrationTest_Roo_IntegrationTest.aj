...
privileged aspect FilmIntegrationTest_Roo_IntegrationTest {
    ...
    public void FilmIntegrationTest.testFlush() {
        ...
        obj.flush();
        Assert.assertTrue("Version for 'Film' failed to increment on flush directive", (currentVersion != null && obj.getVersion() > currentVersion) || !modified);
    }
    
    @Test
    public void FilmIntegrationTest.testMergeUpdate() {
        Film obj = dod.getRandomFilm();
        Assert.assertNotNull("Data on demand for 'Film' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Film' failed to provide an identifier", id);
        ...
        boolean modified =  dod.modifyFilm(obj);
        Integer currentVersion = obj.getVersion();
        Film merged = obj.merge();
        obj.flush();
        Assert.assertEquals("Identifier of merged object not the same as identifier of original object", merged.getId(), id);
        Assert.assertTrue("Version for 'Film' failed to increment on merge and flush directive", (currentVersion != null && obj.getVersion() > currentVersion) || !modified);
    }
